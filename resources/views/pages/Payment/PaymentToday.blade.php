...
@section('title', 'Payments Today List')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="card-title">Payments Today List</h4>
                        </div>
                        <div class="col-md-6" align="right">
                            <a href="{{route('payment.status')}}" class="btn btn-dark"><i class="now-ui-icons arrows-1_refresh-69"></i> Refresh</a>  <a href="{{route('create.payment')}}" class="btn btn-success" ><i class="now-ui-icons ui-1_simple-add"></i> Add New Payment</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
