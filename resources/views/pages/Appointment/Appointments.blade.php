            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6" align="right">
                        <a href="{{route('appointments')}}" class="btn btn-dark"><i class="now-ui-icons arrows-1_refresh-69"></i> Refresh</a>   <a href="{{route('create.appointment')}}" class="btn btn-success" ><i class="now-ui-icons ui-1_simple-add"></i> Add New Appointment</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
